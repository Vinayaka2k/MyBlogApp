        ...
        <div className="min-h-screen bg-secondaryBg">
            ...
            </div>
            {
                ...
                <div id="blog" className="lg:flex p-2">
                    <div id="main" className="h-auto w-100 lg:w-5/6 py-2 px-4 lg:h-auto min-h-full overflow-hidden">
                    ...
                    <div id="menu" className="h-auto w-100 lg:h-auto lg:w-1/6 min-h-full mt-8 lg:mt-0 sm:px-6 md:space-y-4 lg:block flex space-x-4">
